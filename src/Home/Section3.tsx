...
function ServiceIconShape({ icon }: { icon: ServiceIcon }) {
  if (icon === 'shield') {
    return (
      <div className="motion-float-soft relative h-32 w-28 sm:h-32 sm:w-28">
  ...
  return (
    <div className="motion-float-soft relative grid h-28 w-28 place-items-center sm:h-32 sm:w-32">
...
function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <article
      style={style}
      className={`motion-shimmer group relative overflow-hidden rounded-[30px] border border-white/10 bg-[#020613]/85 transition duration-300 hover:-translate-y-1 ${
        isWide
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-x-0 top-[220px] hidden h-[920px] lg:block">
        ...
        <span
          className="motion-float-reverse absolute left-[30%] top-[280px] h-[330px] w-[330px] rounded-full bg-cyan-500/16 blur-[130px]"
          style={{ animationDelay: '1.4s' }}
        />
        <span
          className="motion-float absolute right-[31%] top-[258px] h-[330px] w-[330px] rounded-full bg-amber-500/16 blur-[130px]"
          style={{ animationDelay: '2.1s' }}
        />
        <span
          className="motion-float-reverse absolute right-[4%] top-[220px] h-[360px] w-[360px] rounded-full bg-indigo-500/18 blur-[130px]"
          style={{ animationDelay: '0.8s' }}
        />
        <span
          className="motion-float absolute left-[26%] top-[620px] h-[360px] w-[360px] rounded-full bg-sky-500/18 blur-[130px]"
          style={{ animationDelay: '1.8s' }}
        />
        <span
          className="motion-float-reverse absolute right-[24%] top-[620px] h-[360px] w-[360px] rounded-full bg-red-500/18 blur-[130px]"
